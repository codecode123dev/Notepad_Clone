            ...
            <div class="row">
              <div class="col-xs-12 col-sm-3">
                ...
                <v-dialog v-model="dialog_folder_manager" width="auto">
                  <template v-slot:activator="{ props }">
                    <!-- <v-btn color="primary" v-bind="props"> Open Dialog </v-btn> -->
                    <ul class="folder-option" id="folderOption" v-bind="props" type="button">
                      <li>
                        <a>Manage Folders</a>
                      </li>
                    </ul>
                    ...
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        ...
                        <div class="modal-body" id="manageFolderContent">
                          <div class="row">
                            <div class="col-xs-8">
                              <input class="button_xs_8" type="text" id="newFolder" maxlength="50" placeholder="Folder Name">
                            </div>
                            <div class="col-xs-4" >
                              <input class="button_xs_4" type="button" value="Create New">
                            </div>
                          </div>
                        </div>
                        <div class="modal-footer">
...
.theme-light .modal-dialog input, .theme-light .modal-dialog textarea, .theme-light .modal-dialog select {
    background: #fff;
    color: #1e1e1e;
    border-radius: 4px;
    border: 1px solid #666;
